...
//---- end new code
	...
	protected function getLocalImagePath($src){
		...
		if(file_exists ($this->docRoot . '/car_booking/' . $src)) {
			$this->debug(3, "Found file as " . $this->docRoot . '/car_booking/' . $src);
			$real = $this->realpath($this->docRoot . '/car_booking/' . $src);
