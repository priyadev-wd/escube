                    ...
                    <div class="box">
                        <div class="box-body">
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-3 row-seperate">
                                            <label>category<strong style="color:#F00;">*</strong></label>
                                        </div>
                                    ...
                                    <!--<div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-9 row-seperate">
                                            <input class="form-control" name="dimension" placeholder="Dimensions" type="text"
                                                value="<?php echo $category['category_dimension']; ?>" required>
                                        </div>
                                    </div>--->
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-9 row-seperate">
                                            <a href="<?php echo base_url();?>uploads/category/<?php echo $category['category_img']; ?>"
                                                class="fancybox-media">
                                                <img src="<?php echo base_url(); ?>uploads/category/<?php echo $category['category_img']; ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-3 row-seperate">
                                            <label>Update Default Image(size:196*254)<strong
                             ...
                             <div class="col-xs-12 col-sm-9 row-seperate">
	    <input class="form-control" name="ban[]"  type="file">
      <img src="<?php echo base_url();?>uploads/innerbanners/<?php echo $category['category_banner']?>" style="width:100%;height:300px;margin:20px 0px;object-fit:contain;"> 
