                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-9 row-seperate">
                                            <input class="form-control" name="name" placeholder="Name" type="text"
                                                value="<?php echo $testimonial['testimonial_name']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-9 row-seperate">
                                            <input class="form-control" name="place" placeholder="Place" type="text"
                                                value="<?php echo $testimonial['testimonial_place']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-9 row-seperate">
                                            <textarea class="form-control" name="desc_i" id="" rows="5" cols="40"
                                                maxlength="290" type="text"><?php echo 
													 $testimonial['testimonial_desc']; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-9 row-seperate">
                                            <a href="<?php echo base_url();?>uploads/testimonial/<?php echo $testimonial['testimonial_img']; ?>"
                                                class="fancybox-media">
                                                <img src="<?php echo base_url(); ?>uploads/testimonial/<?php echo $testimonial['testimonial_img']; ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-3 row-seperate">
                                            <label>Update Default Image(size:190*190)<strong style="color:#F00;"></strong></label>
