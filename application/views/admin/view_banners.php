                        ...
                        <table id="datatable" class="table table-bordered table-striped delTable">
                            ...
                            <tbody>
                                ...
                                <tr id="<?php echo $val->ban_id;?>">
                                    ...
                                    <td>
                                        <a href="<?php echo base_url();?>uploads/banners/<?php echo $val->ban_image; ?>"
                                            class="fancybox-media">
                                            <img src="<?php echo base_url();?>uploads/banners/<?php echo $val->ban_image; ?>"
                                                style="width:170px;height:100px;"></a>
                                    </td>
                                    <td>
                                        <a style="color:rgb(102, 102, 102);"
                                            href="<?php echo base_url(); ?>admin/Banner/EditBanner/<?php echo $val->ban_id;?>"
