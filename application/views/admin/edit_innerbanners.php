<?php $this->load->view('admin/includes/header');?>
          ...
          <div class="row">
			...
			<form name="add_menu" id="add_menu" method="POST" enctype="multipart/form-data" >
              ...
              <div class="col-xs-12 col-sm-9 row-seperate">
                <input class="form-control" name="title" value="<?php echo $banner_data['title']?>" placeholder="Title" type="text" readonly> 
              </div>
          </div>
      ...
      <img src="<?php echo base_url();?>uploads/innerbanners/<?php echo $banner_data['image']?>" style="width:100%;height:300px;margin:20px 0px;object-fit:contain;"> 
